...
from authapp.models import Contact, MembershipPlan, Trainer, Enrollment, Gallery, Attendance, Person
from rest_framework.decorators import api_view
from rest_framework.response import Response
from authapp .serializers import PeopleSerializer
...
def index(request):
    courses = {
        'coursename': 'Python',
        'learn': ['flask', 'Djagno', 'Tornado', 'Fast Api'],
